...
func label_a1(a: [Int]) -> Int?{
    print("1. Execute label with value: \(a)")
    return a[0]
}
func label_a2(a: [(Int) -> Int]) -> ((Int) -> Int)?{
...
let a1 = Arc<Int, Int>(label: label_a1, connectedPlaceIn: p1, connectedPlaceOut: nil, direction: .fromPlace      , name: "a1")
let a2 = Arc<(Int) -> Int, (Int) -> Int>(label: label_a2, connectedPlaceIn: p2, connectedPlaceOut: nil, direction: .fromPlace      , name: "a2")

// entry arcs are not function ?
let a3 = Arc<Any, Int>(label: l_a3, connectedPlaceIn: nil, connectedPlaceOut: p3,  direction: .fromTransition , name: "a2")
